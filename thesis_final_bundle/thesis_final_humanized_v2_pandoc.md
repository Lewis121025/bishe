...
| --- | --- | --- | --- | --- |
| OLS | 0.0180 | 0.5656 | 0.4342 | 0.0246 ± 0.0045 |
| Lasso | 0.0177 | 0.5657 | 0.4338 | 0.0248 ± 0.0045 |
| 随机森林 | 0.0886 | 0.5449 | 0.4187 | 0.0811 ± 0.0053 |
| XGBoost | 0.0947 | 0.5430 | 0.4181 | 0.0937 ± 0.0086 |
...
| --- | --- | --- | --- | --- | --- | --- |
| Logit | 0.5364 | 0.5537 | 0.5478 | 0.5507 | 0.5518 | 0.5705 |
| 随机森林分类器 | 0.5760 | 0.6004 | 0.5458 | 0.5718 | 0.6125 | 0.6204 |
| XGBoost分类器 | 0.5857 | 0.6083 | 0.5649 | 0.5858 | 0.6250 | 0.6309 |
| 决策树 | 0.5302 | 0.5448 | 0.5738 | 0.5589 | 0.5543 | 0.5671 |
...
样本外验证与多源数据融合同样值得推进。本文的机器学习分析虽然已经采用训练集、测试集划分和按公司分组的交叉验证，但总体上仍局限于当前样本框架，年报、社会责任报告和媒体报道等文本信息的利用也相对有限，相关结果更多体现为对传统回归结论的补充说明。由于机器学习部分进一步要求国有企业标记变量、治理特征和企业属性等输入变量完整，最终样本小于基础回归样本，因此第五章结果更适合被理解为特征更完整样本上的补充证据，而不宜机械外推至全部基础样本。未来研究可借助滚动窗口、跨市场样本和多源文本信息融合等方式，检验模型在不同阶段和不同情境下的稳健性，以便更全面地揭示财政补贴影响高管薪酬的作用机制。
